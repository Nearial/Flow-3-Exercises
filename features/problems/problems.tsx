...
import { useGetProblems, usePostProblems } from './problem-hooks'
...
export function Problems() {
  ...
  const { mutate: createProblem } = usePostProblems()
  ...
  return (
    ...
    <View style={{flex:1}}>
      {camera ? <Picture setCamera={setCamera} setPhotoToDisplay={setPhotoToDisplay}></Picture> : <>
        ...
        <Button title="Create problem" onPress={handleAddProblem}/>
